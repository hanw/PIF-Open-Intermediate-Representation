...
class SimpleQueueManager(ThreadedProcessor):
    ...
    @param meta_ir_traffic_manager_attrs The  MetaIR TM attributes
    ...
    """
    def __init__(self, name, meta_ir_traffic_manager_attrs, port_count):
        ThreadedProcessor.__init__(self, name)
        self.port_count = port_count
        self.next_processor = None
        self.q_per_port = meta_ir_traffic_manager_attrs["queues_per_port"]
        if "max_bytes" in meta_ir_traffic_manager_attrs.keys():
            self.max_bytes = meta_ir_traffic_manager_attrs["max_bytes"]
