...
class Processor(object):
    ...
    Currently in AIR, only linear layouts of processor instances are
    ...
    def process(self, parsed_packet):
        ...
        processor.
        """
        raise MetaIRImplementation("Super class %s does not implement process"
                                % str(type(self)))
...
class ThreadedProcessor(Thread, Processor):
    ...
    def _process(self, parsed_packet):
        ...
        """
        raise AirImplementationError("Processor %s: Super class %s " %
